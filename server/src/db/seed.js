...
const USERS = [
  { username: 'turmamais', displayName: 'Equipa Turma+', role: 'admin', color: '#16A34A', bio: 'A conta oficial do Turma+ 📚 Novidades, dicas de estudo e avisos do calendário.', school: 'Turma+', district: 'Lisboa', municipality: 'Lisboa', gradeYear: '', course: '' },
  { username: 'maria.silva', displayName: 'Maria Silva', color: '#DB2777', bio: '12.º ano, Ciências. Rumo a Medicina 🩺 Café + fichas de estudo = sobrevivência.', school: 'Escola Secundária D. Pedro V', district: 'Lisboa', municipality: 'Lisboa', gradeYear: '12.º ano', course: 'Ciências e Tecnologias' },
  ...
  { username: 'ana.costa', displayName: 'Ana Costa', color: '#7C3AED', bio: '12.º ano em Coimbra. Flashcards até ao infinito ♾️', school: 'Escola Secundária José Falcão', district: 'Coimbra', municipality: 'Coimbra', gradeYear: '12.º ano', course: 'Ciências e Tecnologias' },
  ...
  { username: 'sofia.oliveira', displayName: 'Sofia Oliveira', color: '#059669', bio: 'Madeira 🌺 11.º ano. Ponho aqui as dúvidas que não tenho coragem de fazer na aula.', school: 'Escola Secundária Jaime Moniz', district: 'Madeira', municipality: 'Funchal', gradeYear: '11.º ano', course: 'Línguas e Humanidades' },
  ...
  { username: 'ines.pereira', displayName: 'Inês Pereira', color: '#9333EA', bio: '12.º em Leiria. Conta decrescente para os exames ⏳', school: 'Escola Secundária Francisco Rodrigues Lobo', district: 'Leiria', municipality: 'Leiria', gradeYear: '12.º ano', course: 'Línguas e Humanidades' },
];

const POSTS = [
  { u: 'turmamais', h: 2, subject: 'Turma+', content: 'Bem-vindos ao Turma+! 🎒\n\nO que podes fazer aqui:\n📰 Feed com a comunidade estudantil de todo o país\n📅 Calendário com feriados (nacionais e do teu município), férias e greves\n💬 Mensagens diretas e grupos de estudo\n📖 Apoio: fichas de estudo, calculadora de equações e planos de estudo até ao exame\n\nCompleta o teu perfil (escola, ano e município) para o calendário se ajustar a ti.' },
  { u: 'turmamais', h: 50, subject: 'Regresso às aulas', content: 'Ano letivo 2026/27 a arrancar! 🏫\n\nJá tens no Calendário os períodos letivos, as férias e os feriados. Dica: exporta o calendário (.ics) para o telemóvel no botão "Exportar" — assim recebes tudo na tua app de calendário habitual.\n\n#RegressoÀsAulas #AnoLetivo2627' },
  { u: 'maria.silva', h: 4, subject: '', content: 'Primeira semana de 12.º ano feita. Balanço: FQ já me deve duas noites de sono e ainda nem houve testes 😅\n\nQuem mais vai fazer exames de Matemática A e Biologia? #12ºAno #ExamesNacionais', poll: { question: 'Qual é o teu maior medo deste ano letivo?', options: ['Exames nacionais', 'Apresentações orais', 'Acordar cedo', 'Escolher o curso'] } },
  { u: 'tiago.martins', h: 7, subject: 'Matemática A', content: 'Dica que me salvou em derivadas: antes de derivar, simplifica SEMPRE a expressão. Metade dos erros que fazia eram álgebra, não derivadas 🤦‍♂️\n\nUsei a ficha "Derivadas" do Apoio e os passos termo a termo ajudam imenso. #MatemáticaA' },
  { u: 'joao.santos', h: 10, subject: '', content: 'Porto em modo setembro: mochila nova, chuva no primeiro dia e o míster de Ed. Física a dizer que "este ano é para levar a sério" 💪\n\nAlguém mais do norte por aqui? #Porto #RegressoÀsAulas' },
  ...
  { u: 'beatriz.almeida', h: 20, subject: '', content: 'Gente de Setúbal do 10.º ano! Estou a montar um grupo de estudo para Socioeconómica (Matemática Aplicada + Economia). Quem alia, mande mensagem 🙋‍♀️ #Setúbal #GrupoDeEstudo' },
  { u: 'turmamais', h: 28, subject: 'Apoio', content: 'Sabias? O separador Apoio não é um chatbot genérico — é um explicador com fichas de estudo do currículo português:\n\n📐 Equações do 2.º grau com passos\n🧪 Redox, pH, leis de Newton\n📚 Os Lusíadas, Pessoa, Estado Novo\n🧠 Métodos de estudo com evidência científica\n\nGratuito, funciona offline e guarda as fichas nos teus Apontamentos. Experimenta!' },
  { u: 'ines.pereira', h: 33, subject: 'Português', content: 'Resumo que fiz d\'Os Lusíadas para quem está a começar agora: 4 planos (Viagem, Deuses, História de Portugal, Povo), herói coletivo e oitava rima. Guardem o episódio do Adamastor — sai quase sempre 😤 #Português #Lusíadas' },
  ...
  { u: 'guilherme.sousa', h: 46, subject: '', content: 'Açores a marcar presença! 🌋 O Dia da Região (segunda-feira do Espírito Santo) já está no meu calendário.\n\nPessoal das ilhas: como está o regresso às aulas por aí?' },
  ...
  { u: 'diogo.carvalho', h: 70, subject: '', content: 'Viseu aqui! Basquete às 7h30 antes das aulas = chegar a FQ a pensar em triplos e não em moles ⛹️\n\nAlguém consegue treinar de manhã e render nas aulas? Dicas?' },
  { u: 'maria.silva', h: 80, subject: 'Métodos de estudo', content: 'Fiz um plano de estudo no Apoio até aos exames de junho: 3 fases (diagnóstico → revisão → prática com provas antigas) e 6 h/semana realistas.\n\nImprimi e colei na secretária. Quem quiser faço partilha do método 📌 #Estudo #ExamesNacionais' },
  { u: 'turmamais', h: 96, subject: 'Calendário', content: '⚠️ Nota sobre greves escolares: os registos de greve nesta versão são dados de demonstração.\n\nNuma versão de produção, esta secção seria alimentada por fontes oficiais (pré-avisos sindicais publicados e comunicados do Ministério da Educação), com verificação editorial antes de publicar. Vê os detalhes na Política de Privacidade e nos Termos.' },
  ...
  { u: 'joao.santos', h: 130, subject: 'Física e Química A', content: 'FQ: as leis de Newton finalmente fizeram clique quando percebi que a Normal NEM SEMPRE é igual ao peso (planos inclinados, elevadores a acelerar…).\n\nDiagrama de corpo livre SEMPRE antes de calcular. Obrigado à ficha do Apoio 🙏 #FísicaQuímicaA' },
  { u: 'ines.pereira', h: 142, subject: 'História A', content: '25 de Abril: fixe que o MFA usou duas senhas de rádio — "E depois do adeus" e "Grândola, Vila Morena". Pormenores destes valem pontos nos critérios de correção ✍️ #HistóriaA' },
];
...
const COMMENTS = [
  ...
  { post: 2, u: 'ana.costa', h: 1.5, content: 'Biologia também 🧬 vamos montando grupo de estudo!' },
  ...
  { post: 17, u: 'maria.silva', h: 118, content: 'Nenhuma solução real — Δ negativo 👌' },
...
export function ensureSeed({ force = false } = {}) {
  ...
  const g1 = mkConv('group', 'Estudo Matemática A 📐', ['maria.silva', 'tiago.martins', 'ines.pereira', 'ana.costa']);
  ...
  mkMsg(g1, 'ines.pereira', 'Obrigada! Eu sou de Humanidades mas Matemática também me apanha 😅', hoursAgo(4.5));
  ...
  mkMsg(g2, 'rita.rodrigues', 'Faro presente (e a derreter) ☀️', hoursAgo(18));
  ...
  mkMsg(d1, 'joao.santos', 'A propósito, no fim de semana há jogo do Porto. Se o grupo de estudo quiser pausa… 😁', hoursAgo(0.5));
